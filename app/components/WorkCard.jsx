        ...
        <AnimatePresence>
            ...
            >
                ...
                >
                    <Suspense
                        fallback={
                            <div className='flex h-[400px] w-[320px] items-center justify-center rounded-lg border-[1px] border-slate-200'>
                    ...
                    >
                        <Image
                            loading='lazy'
                            className='workimage -z-10 aspect-4/5 overflow-hidden rounded-lg bg-slate-700 object-cover'
                            src={imageUrl}
                            height={400}
                            width={320}
