    ...
    return (
        <AnimatePresence>
            ...
            >
                ...
                <div className='relative container h-[312px] w-[400px] scale-[0.48] rounded-full hover:scale-[0.54] md:scale-[0.58] hover:md:scale-[0.65]'>
                    ...
                    <Image
                        ...
                        className='absolute -bottom-10 left-2 h-[75px] w-[75px] border-primary-700 border-4 rounded-full'
                    />
                </div>
